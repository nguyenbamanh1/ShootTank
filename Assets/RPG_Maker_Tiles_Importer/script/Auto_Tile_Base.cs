...
namespace IGL_Tech.RPGM.Auto_Tile_Importer
{
    public class Auto_Tile_Base : Tile
    {
        ...
        public bool InCamera(ITilemap tilemap)
        {
            BoundsInt tilemapBounds = tilemap.cellBounds;
            Camera mainCamera = Camera.main;
            Bounds cameraBounds = new Bounds(mainCamera.transform.position, new Vector3(mainCamera.orthographicSize * mainCamera.aspect * 2f, mainCamera.orthographicSize * 2f, 0f));
            return cameraBounds.Intersects(new Bounds(tilemapBounds.center, tilemapBounds.size));
        }
